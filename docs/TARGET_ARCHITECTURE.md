...
Задача контура настроек и ресурсов — описать, какие возможности доступны в конкретной среде: включённые интеграции, доступные исполнительные модули, модели, привязки ресурсов, авторизацию, локальные и глобальные переопределения.
