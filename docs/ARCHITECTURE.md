...
`dry-run` должен блокировать внешние побочные действия, например отправку комментариев, изменение статусов, создание pull request и иные интеграционные операции записи.
