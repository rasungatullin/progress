...
7. результат передаётся в верификацию и фиксируется в проектном состоянии;
...
Назначение контура — получение, поиск и унификация сведений из внешних источников, необходимых для принятия решения и исполнения задачи.

Подробное описание: `docs/contours/integration/README.md`

### 5.3 Контур принятия решения

Назначение контура — определение дальнейшего режима обработки, выбор сценария и формирование задания на исполнение.
...
## 6. Ближайшие архитектурные задачи
