  ...
  "actions": [
    {
      ...
      "profile": "coder",
      "structured_output_fields": ["summary", "commit_message", "changes", "commands", "conclusion"],
      ...
      "operations": [
        ...
        {"name": "allocate-resources", "kind": "allocate-resources", "required": true, "in": {"invocation": {"ref": "data.invocation"}, "profile": {"ref": "data.profile"}}, "out": {"allocation": {"ref": "data.allocation"}}},
        ...
        {"name": "build-directive", "kind": "build-directive", "required": true, "in": {"invocation": {"ref": "data.invocation"}, "profile": {"ref": "data.profile"}, "allocation": {"ref": "data.allocation"}, "workplace": {"ref": "data.workplace"}, "structured_output_fields": {"ref": "action.structured_output_fields"}}, "out": {"directive": {"ref": "data.directive"}}},
        {"name": "launch-synthesis", "kind": "launch-synthesis", "required": true, "in": {"invocation": {"ref": "data.invocation"}, "directive": {"ref": "data.directive"}, "profile": {"ref": "data.profile"}, "allocation": {"ref": "data.allocation"}, "workplace": {"ref": "data.workplace"}}, "out": {"result": {"ref": "data.result"}}},
        {"name": "parse-result", "kind": "parse-result", "required": true, "in": {"result": {"ref": "data.result"}, "structured_output_fields": {"ref": "action.structured_output_fields"}}, "out": {"structured_output": {"ref": "data.structured_output"}}},
        {"name": "commit-push", "kind": "commit-push", "required": true, "in": {"directory": {"ref": "data.workplace.name"}, "commit_message": {"ref": "data.structured_output.commit_message"}, "fallback_name": {"ref": "data.invocation.workplace.name"}, "git": {"ref": "data.allocation.git"}, "private_store": {"ref": "data.allocation.private_store"}, "config_home": {"ref": "data.allocation.config_home"}}, "out": {"commit_summary": {"ref": "data.commit_summary"}}},
        {"name": "finalize", "kind": "finalize", "required": true, "in": {"action_name": {"ref": "action.name"}, "action_class": {"ref": "action.class"}, "invocation": {"ref": "data.invocation"}, "profile": {"ref": "data.profile"}, "allocation": {"ref": "data.allocation"}, "workplace": {"ref": "data.workplace"}, "result": {"ref": "data.result"}}, "out": {"result": {"ref": "data.result"}}}
      ]
    },
    {
      ...
      "class": "review",
      "profile": "review",
      "structured_output_fields": ["summary", "remarks", "conclusion"],
      "requires_workplace": true,
      "operations": [
        {"name": "prepare-data", "kind": "prepare-data", "required": true, "in": {"invocation": {"ref": "in.invocation"}, "expected_result": {"ref": "in.expected_result"}, "constraints": {"ref": "in.constraints"}, "canonical_task": {"ref": "in.canonical_task"}, "related_objects": {"ref": "in.related_objects"}, "reasons": {"ref": "in.reasons"}, "structured_input": {"ref": "in.structured_input"}}, "out": {"structured_input": {"ref": "data.structured_input"}, "workplace": {"ref": "data.workplace"}, "invocation": {"ref": "data.invocation"}}},
        {"name": "resolve-profile", "kind": "resolve-profile", "required": true, "in": {"profile_name": {"ref": "action.profile"}, "invocation": {"ref": "data.invocation"}}, "out": {"profile": {"ref": "data.profile"}, "result": {"ref": "data.result"}}},
    ...
    },
    {
      ...
      "class": "engineering-synthesis",
      "profile": "coder",
      "structured_output_fields": ["summary", "commit_message", "review_responses", "changes", "commands", "conclusion"],
      "requires_workplace": true,
      "operations": [
        {"name": "prepare-data", "kind": "prepare-data", "required": true, "in": {"invocation": {"ref": "in.invocation"}, "expected_result": {"ref": "in.expected_result"}, "constraints": {"ref": "in.constraints"}, "canonical_task": {"ref": "in.canonical_task"}, "related_objects": {"ref": "in.related_objects"}, "reasons": {"ref": "in.reasons"}, "structured_input": {"ref": "in.structured_input"}}, "out": {"structured_input": {"ref": "data.structured_input"}, "workplace": {"ref": "data.workplace"}, "invocation": {"ref": "data.invocation"}}},
        {"name": "resolve-profile", "kind": "resolve-profile", "required": true, "in": {"profile_name": {"ref": "action.profile"}, "invocation": {"ref": "data.invocation"}}, "out": {"profile": {"ref": "data.profile"}, "result": {"ref": "data.result"}}},
