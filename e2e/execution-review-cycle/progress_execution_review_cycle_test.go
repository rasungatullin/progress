  ...
  "actions": [
    {
      ...
      "operations": [
        ...
        {"name": "build-directive", "kind": "build-directive", "required": true, "in": {"invocation": {"ref": "data.invocation"}, "profile": {"ref": "data.profile"}, "allocation": {"ref": "data.allocation"}, "workplace": {"ref": "data.workplace"}}, "out": {"directive": {"ref": "data.directive"}}},
        ...
        {"name": "parse-result", "kind": "parse-result", "required": true, "in": {"result": {"ref": "data.result"}}, "out": {"structured_output": {"ref": "data.structured_output"}}},
