	...
	return Registry{
		...
		Contracts: []Contract{
			...
			},
			{
				...
				Target:  Decision,
				Kind:    ContractKindRead,
				Object:  "маршрут обработки и действие",
				Summary: "Контур методик предоставляет контуру принятия решения переносимые маршруты, проверки и действия.",
				Invariants: []string{
			...
			},
			{
				...
				Summary: "Контур настроек и ресурсов задаёт окружения исполнения, инструменты исполнения, ресурсы исполнения, привязки ресурсов и локальные переопределения.",
				Invariants: []string{
